...
config.output.filename = `auth0-box-serverless.ui.${project.version}.js`;
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin(`auth0-box-serverless.ui.${project.version}.css`, {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', `auth0-box-serverless.ui.vendors.${project.version}.js`),
